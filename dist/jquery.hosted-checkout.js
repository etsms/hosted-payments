...
(function ($, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
    ...
    buildCurrentUrl: function buildCurrentUrl() {
      ...
      var hasQuery =
        currentHref.indexOf("?") > 0 || currentHref.indexOf("&") > 0;
        ...
        _this2
          ...
          .then(function (sessionResponse) {
            return _this2.createSession(
              sessionResponse.resource.sessionToken,
              sessionResponse.href
            );
          })
          .then(
    ...
    authenticateSession: function authenticateSession() {
      ...
      var sessionUrl =
        "issuer/" + this.options.issuerId + "/session/authenticate/api-key";
      $.ajax({
        type: "POST",
        url: sessionUrl,
        data: JSON.stringify({
